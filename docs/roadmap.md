...
- Paginated public image/video collections, safe metadata and stable media paths.
...
See [configuration](configuration.md), the [consumer guide](catalog-api.md) and
...
The settled surface is catalog, preview/poster and privacy-permitted exact
